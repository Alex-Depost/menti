      ...
      <div className="space-y-6 bg-white p-6 rounded-lg shadow">
        <div className="flex flex-col items-center">
          <div className="relative mb-4 group">
            ...
            <div 
              className="absolute bottom-0 right-0 bg-gray-500 text-white w-8 h-8 rounded-full flex items-center justify-center cursor-pointer"
              onClick={() => fileInputRef.current?.click()}
            >
        ...
        <button
          type="submit"
          className="w-full bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-700 transition-colors"
        >
          Сохранить
        </button>
      </div>
